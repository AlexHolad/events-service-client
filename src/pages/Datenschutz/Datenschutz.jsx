...
export default function Datenschutz() {
  return (
    <div className="gen__container">
      ...
      <h3>hCaptcha</h3>{" "}
      <p>
        Wir nutzen hCaptcha (im Folgenden &bdquo;hCaptcha&ldquo;) auf dieser
        Website. Anbieter ist die Intuition Machines, Inc., 2211 Selig Drive,
        Los Angeles, CA 90026, USA (im Folgenden &bdquo;IMI&ldquo;).
      </p>{" "}
      <p>
        Mit hCaptcha soll &uuml;berpr&uuml;ft werden, ob die Dateneingabe auf
        dieser Website (z.&nbsp;B. in einem Kontaktformular) durch einen
        Menschen oder durch ein automatisiertes Programm erfolgt. Hierzu
        analysiert hCaptcha das Verhalten des Websitebesuchers anhand
        verschiedener Merkmale.
      </p>{" "}
      <p>
        Diese Analyse beginnt automatisch, sobald der Websitebesucher eine
        Website mit aktiviertem hCaptcha betritt. Zur Analyse wertet hCaptcha
        verschiedene Informationen aus (z.&nbsp;B. IP-Adresse, Verweildauer des
        Websitebesuchers auf der Website oder vom Nutzer get&auml;tigte
        Mausbewegungen). Die bei der Analyse erfassten Daten werden an IMI
        weitergeleitet. Wird hCaptcha im &bdquo;unsichtbaren Modus&ldquo;
        verwendet, laufen die Analysen vollst&auml;ndig im Hintergrund.
        Websitebesucher werden nicht darauf hingewiesen, dass eine Analyse
        stattfindet.
      </p>{" "}
      <p>
      ...
      <p>
        Die Datenverarbeitung wird auf Standardvertragsklauseln gest&uuml;tzt,
        die in den Datenverarbeitungszusatz zu den Allgemeinen
        Gesch&auml;ftsbedingungen von IMI bzw. den
        Datenverarbeitungsvertr&auml;gen enthalten sind.
      </p>{" "}
      <p>
        Weitere Informationen zu hCaptcha entnehmen Sie den
        Datenschutzbestimmungen und Nutzungsbedingungen unter folgenden Links:{" "}
        <a
